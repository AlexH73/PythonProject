...
чтобы расставить между этими числами знаки операций '+' и '*', а также, возможно, скобки.
...
# Вычисление максимального значения выражения
result = max_expression(a, b, c)

print("Максимальное значение выражения:", result)
